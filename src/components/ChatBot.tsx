...
const chatKnowledgeBase: Record<string, string> = {
  ...
  'почта': 'Email: yur.nedv@mail.com. Также мы в VK (https://vk.com/yur.nedv) и Telegram (https://t.me/yur_nedv).',
  'контакты': 'Телефон: +7 980 555 75 80, Email: yur.nedv@mail.com, VK: vk.com/yur.nedv, Telegram: t.me/yur_nedv',
