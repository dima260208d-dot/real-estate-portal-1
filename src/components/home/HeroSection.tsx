    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
        <div className="mb-6 animate-fade-in flex justify-center relative w-full mt-8">
          ...
          <div className="relative z-10 inline-block bg-white/20 backdrop-blur-lg px-8 py-4 rounded-3xl shadow-[0_0_80px_rgba(255,255,255,0.3)] border-2 border-white/40">
            <h1 className="text-2xl md:text-4xl font-extrabold text-white animate-logo-glow transition-all duration-700 hover:scale-105 cursor-pointer tracking-tight" style={{ 
