...
export default function HeroSection({ onConsultationClick }: HeroSectionProps) {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 bg-gradient-to-br from-black/60 via-primary/40 to-secondary/35 z-10" />
        ...
        <div className="mb-6 animate-fade-in flex justify-center relative w-full -mt-20">
          ...
          <div className="relative z-10 inline-block">
            <img 
              ...
              className="h-16 md:h-28 w-auto object-contain animate-logo-glow transition-all duration-700 hover:scale-110 cursor-pointer brightness-[1.3] contrast-[1.1] drop-shadow-[0_0_30px_rgba(255,255,255,0.5)]"
              style={{ maxWidth: '80vw', filter: 'drop-shadow(0 0 20px rgba(255,255,255,0.6))' }}
            />
          </div>
        </div>
