...
export default function Header({ onApplicationClick }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 w-full bg-gray-700 backdrop-blur-sm border-b-2 border-primary shadow-sm z-50">
      ...
      {/* Мобильное меню */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-gray-700 border-t border-primary shadow-lg">
